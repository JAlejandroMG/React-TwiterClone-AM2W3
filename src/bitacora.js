// 1. Crear un estado newTweet dentro del estado de Feed //! Hecho
//{ Se va a hacer en primaryCol.jsx ya que la captura del tweet se hace en postTweet.jsx y no se puede acceder desde el componente feed.jsx
...
// profiles que creaste en el punto no. 2.
...
// ello deberás usar el evento onChange.

// 8. Listar el estado profiles en un nuevo componente llamado
// SearchDropdown en él se mostrará la imagen de perfil del
// usuario, el nombre y el nombre de usuario.

// 9. Por último, deberás publicar tu proyecto en Netlify, debes de
...
// b) Mostrar reacciones de cada tweet – 5 puntos
// c) Habilitar la función de dar like y retweet – 15 puntos //! Hecho
// d) Mostrar/ocultar menú contextual – 15 puntos
// e) Borrar un tweet – 10 puntos
// f) Listar tendencias – 10 puntos //! Hecho
// g) Agregar un tweet – 15 puntos //! Hecho
// h) Búsqueda de perfiles de usuarios –15 puntos
// i) Listar perfiles de usuarios – 10 puntos